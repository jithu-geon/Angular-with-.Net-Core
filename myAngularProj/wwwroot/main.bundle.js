...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_myservice__ = __webpack_require__("../../../../../src/app/services/myservice.ts");
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_myservice__["a" /* MyService */]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__services_myservice__ = __webpack_require__("../../../../../src/app/services/myservice.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["H" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_8__services_myservice__["a" /* MyService */]],
...
/***/ "../../../../../src/app/models/registermodel.model.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var RegisterModel = /** @class */ (function () {
    function RegisterModel(name, email, password) {
        if (name === void 0) { name = ''; }
...
module.exports = "<mat-card class=\"container\">\n  Name <input type=\"text\" class=\"form-control\" [(ngModel)]=\"model.name\" > \n  <br>\n  Email <input type=\"text\" class=\"form-control\"  [(ngModel)]=\"model.email\">\n  <br>\n  password <input type=\"text\" class=\"form-control\" [(ngModel)]=\"model.password\">\n  <br>\n\n  <button class=\"btn btn-success pull-right\" (click)=\"register()\">Register</button>\n</mat-card>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_myservice__ = __webpack_require__("../../../../../src/app/services/myservice.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_registermodel_model__ = __webpack_require__("../../../../../src/app/models/registermodel.model.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(myService) {
        this.myService = myService;
        this.model = new __WEBPACK_IMPORTED_MODULE_2__models_registermodel_model__["a" /* RegisterModel */]();
    }
    RegisterComponent.prototype.ngOnInit = function () {
    };
    RegisterComponent.prototype.register = function () {
        this.myService.register(this.model).subscribe(function (res) { console.log(res); });
    };
...
var MyService = /** @class */ (function () {
    ...
    function MyService(http) {
        this.http = http;
        this.serviceUrl = 'api/Register';
    }
    MyService.prototype.sayHello = function () {
        return this.http.get(this.serviceUrl).map(function (response) {
